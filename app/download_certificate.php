...
<head>
    ...
    <title>Download Certificate - <?php echo htmlspecialchars($course['title']); ?></title>
    ...
    <style>
        * {
        ...
        /* Left Geometric Section - Matching your image */
        .left-decoration {
            position: absolute;
            left: 0;
            top: 0;
        ...
        /* Bottom Section - Matching your layout */
        .cert-footer {
            display: flex;
...
<body>
    <div class="certificate-wrapper">
        <div class="certificate-container" id="certificate">
            ...
            <!-- Left Geometric Decoration - Matching your image -->
                ...
                <div class="certificate-content">
                    ...
                    <div class="cert-footer">
                        ...
                        <div class="signature-section">
                            ...
                            <div class="signature-name">HARUMI KOBAYASHI</div>
                            <div class="signature-title">CEO of CodeLearn</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function downloadCertificate() {
            ...
            const wrapper = certificate.closest('.certificate-wrapper');
